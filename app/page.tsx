...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col">
      ...
      {/* HERO */}
      <section className="relative flex-1 flex flex-col items-center justify-center text-center p-6 overflow-hidden">
  ...
  <div className="relative z-10">
    ...
    <p className="mt-4 text-xs text-neutral-500">
      ...
      >
        ...
        <div className="m-12 grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <Step
